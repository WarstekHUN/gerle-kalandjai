        ...
        private static Scene[] Scenes = {
            ...
            new Scene(new Line[]{
                /*new Line("Gerle végre felszáll a buszra. A buszon már csak egyetlen ülőhely maradt. Ez egy alkoholtól megboldogult férfi mellett volt, pedig még csak reggel 10 óra. Mivel nem tehetett mást, így leült mellé. " +
                    ...
                    "Először az alkeszhez fordul, akit egy kis vita után le is szállít, majd Gerléhez „gurul”:", ref Actors.Narrator, "03/02_narrátor.mp3"),
                new Line("Üdv Hölgyem! Jegyeket és bérleteket.", ref Actors.Jegykezelo, "03/06_Kaller.mp3"),
             ...
             */
             /*new Scene(new Line[]{
                new Line("Hirtelen betoppan egy apuka. Egy picit zilált volt a frizurája, de egyébként normálisnak tűnt. Egészen addig amíg meg nem szólalt.", ref Actors.Narrator, "07/A/01_narrátor_A.mp3"),
                new Line("LAURA!! SANYI ITT VAN GYEREKÉRT!", ref Actors.Sanyi, "07/A/02_Sanyi.mp3"),
                new Line("Jajj, nemár, megint te jöttél érte?. Lali annyival jobb nevelője volt, viszont amióta kiment a németekhez, azóta te meg Csoki jön csak érte...", ref Actors.Dajka_Laura_neni, "07/A/03_Laura.mp3"),
                new Line("ÚÚÚÚ.... TUDSZ NEKEM MESÉLNI EGY MESÉT?? A KIRÁLYLÁNYOS MESÉT.", ref Actors.Sanyi, "07/A/04_Sanyi.mp3"),
                new Line("Ahhoz korábban kell bejönni, alvás idő elött.", ref Actors.Dajka_Laura_neni, "07/A/05_Laura.mp3"),
                new Line("ÉS AZ MIKOR VAN??", ref Actors.Sanyi, "07/A/06_Sanyi.mp3"),
                new Line("Olyan délután 2 környékén.", ref Actors.Dajka_Laura_neni, "07/A/07_Laura.mp3"),
                new Line("ÉS AZ MIKOR VAAN??", ref Actors.Sanyi, "07/A/08_Sanyi.mp3"),
                new Line("Dél után 2 órával.", ref Actors.Dajka_Laura_neni, "07/A/09_Laura.mp3"),
                new Line("RENDBEN, ADDIG ITT MARADOK.", ref Actors.Sanyi, "07/A/10_Sanyi.mp3"),
                new Line("De hisz neked saját otthonod van és ráadásul egy gyerekért jöttél.", ref Actors.Dajka_Laura_neni, "07/A/11_Laura.mp3"),
                new Line("NEM BAJ, Ő IS SZERETNÉ HALLANI BIZTOSAN.", ref Actors.Sanyi, "07/A/12_Sanyi.mp3"),
                new Line("De az óvoda be fog zárni.", ref Actors.Dajka_Laura_neni, "07/A/13_Laura.mp3"),
                new Line("JÓ AKKOR ITT ALSZUNK.", ref Actors.Sanyi, "07/A/14_Sanyi.mp3"),
                new Line("Amíg Laura és Sanyi tovább folytatták a beszélgetésüket, addig Gerlének sikerült elráncigálnia az unokáját. " +
                    ...
                    "Ezután átöleli őt és azt mondja.", ref Actors.Narrator, "07/A/15_narrátor_A.mp3"),
                new Line("Jajj nagyika, köszönöm, hogy elhoztál. Annyira nehéz a többiek mellett az óvodában. Valamiért sosem értik meg, amit mondok nekik... " +
                    "Nem baj, most már elhoztál, így sikeresebb tudok lenni. Köszönöm!", ref Actors.Unoka, "07/A/16_Unoka.mp3"),
                new Line("Kincsem, ez nagyon jól esett. Bárcsak több időt tölthetnénk együtt, de muszáj, hogy visszavigyelek a szüleidnek.", ref Actors.Gerle, "07/A/17_Gerle.mp3"),
                new Line("Ígérem nagyi, ha végre összejön a biznisz, akkor majd elmegyünk Ibizára bulizni egyet.", ref Actors.Unoka, "07/A/18_Unoka.mp3"),
                new Line("Rendben édesem, én bízok benned.", ref Actors.Gerle, "07/A/19_Gerle.mp3"),
                new Line("Ezután Gerle és Andris boldogan és jókedvűen sétált hazafelé. Mikor eljött a búcsú ideje mind a ketten könnybe lábadt szemekkel köszöntek el egymástól. " +
                    "Gerle elindult haza, majd mikor visszaért a portánál megszólítja a portás.", ref Actors.Narrator, "07/A/20_narrátor_A.mp3"),
                new Line("Látom Gerle megint kalandos egy napod volt. Remélem azt tudod, hogy történtek miatt bajba kerülhetsz.", ref Actors.Portas, "07/A/21_portas_A.mp3"),
                new Line("Ugyan már... Ti fiatalok nem tudjátok milyen is az igazi szeretet. Most pedig állj arrébb aranyoskám, sietek a lakásomba. " +
                    "Már nagyon szeretnék aludni, nagyon kimerített ez nap.", ref Actors.Gerle, "07/A/22_Gerle.mp3"),
                new Line("Andris tervei sikeresek voltak és pár hónappal később már Gerlével együtt buliztak Ibizán a legjobb DJ-k zenéire. " +
                    ...
                    "Persze, Andriska rendszeresen látogatta őt. Ekkor mindig csaptak egy jó nagy partyt.", ref Actors.Narrator, "07/A/23_narrátor_A.mp3"),
             }/*, Actors.Unoka.Name ,SceneVersion.A),

             new Scene(new Line[]{
                new Line("Gerle nem jut messzire: Laurával, az óvónővel találja szemben magát.", ref Actors.Narrator, "07/B/01_narrátor_B.mp3"),
                new Line("Őt hagyd ki ebből!", ref Actors.Dajka_Laura_neni, "07/B/02_Laura.mp3"),
                new Line("Mindketten mélyen egymás szemébe néznek." +
                    ...
                    " Gerle is hasonlóképp tesz, de ott neki édességek vannak. Mindkettőjük összeszűkíti a szemét, csak a másikra koncentrál.", ref Actors.Narrator, "07/B/03_narrátor_B.mp3"),
                new Line("Állj félre, és nem esik bántódásod.", ref Actors.Gerle, "07/B/04_Gerle.mp3"),
                new Line("Az nem fog menni.", ref Actors.Dajka_Laura_neni, "07/B/05_Laura.mp3"),
                new Line("Laura izzad. A teremben lévő egész óvodáscsoport elcsendesül. " +
                    ...
                    "Se a macik, se a cukrok nem találtak célba – a levegőben összeütköztek, és kettőjük között pont középen a padlón landoltak.", ref Actors.Narrator, "07/B/06_narrátor_B.mp3"),
